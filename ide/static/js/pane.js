...
changeEvent() {
    ...
    render() {
      return (
            <div>
            <div><input type="checkbox" id="CheckBoxA" ref="CheckBoxA" value="A" onChange={this.changeEvent} /><label>Keras</label></div>
            <div><input type="checkbox" id="CheckBoxB" ref="CheckBoxB" value="B" onChange={this.changeEvent} /><label>TensorFlow</label></div>
            <div><input type="checkbox" id="CheckBoxC" ref="CheckBoxC" value="C" onChange={this.changeEvent} /><label>Caffe</label></div>
