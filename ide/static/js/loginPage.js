...
class Login extends React.Component {
  ...
  render() {
    if(this.state.loginState) {
      ...
      return (
        <div>
          <img src="/static/img/fabrik_sample.png" className="img-fabrik-sample sample-1"></img>
          <img src="/static/img/fabrik_sample_2.png" className="img-fabrik-sample sample-2"></img>
