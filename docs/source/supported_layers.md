...
The columns Frabrik Caffe, Fabrik Keras, and Fabrik Tensorflow show which layers are currently supported by Fabrik in those libraries.

Below are tables showing which layers are supported by Caffe, Keras, and Tensorflow:
 ### Core Layers
| Layer                     | Caffe         | Keras        | Tensorflow  | Fabrik Caffe  | Frabrik Keras    | Frabrik Tensorflow  |
| :-----------------------: | :-----------: | :----------: | :---------: | :-----------: | :--------------: | :-----------------: | 
| Activation                | √             | √            | √           | √×            | √×               | √×                  | 
