...
- Moving to the next line in the image, we create a new json element (layer). The line ```// Only Caffe``` tells us that, this layer is only for caffe and not for keras.
...
- Keywords' explanation:
    ...
    - color: Colour of the layer to be shown in the frontend.
...
- Run the fabrik application on your local machine by following the instructions in [README](https://github.com/Cloud-CV/Fabrik/blob/master/README.md) file.

<img src="https://raw.githubusercontent.com/Cloud-CV/Fabrik/master/tutorials/layertesting.png" />

- Check the new layer inside the category you added to. See if all the parameters are properly displayed and usable as you wanted.
